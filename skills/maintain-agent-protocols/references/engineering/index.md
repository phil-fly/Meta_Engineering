...
```text
UI 页面、组件、交互、权限渲染、前端请求  → frontend/index.md
...
命名、状态语义、悬空引用、根因修复        → core/common-quality.md
...
- Go/Java/Rust 后端任务：先读 `backend/index.md` 和对应语言文件，再按需要补充 `core/`、`security/`、`performance/`。
